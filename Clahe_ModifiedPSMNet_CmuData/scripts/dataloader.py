...
class StereoDataset(Dataset):
  def __init__(self, data_dir,
    ...
    cmu_data_dict = {
        'train': 'gdrive/MyDrive/CMU_Data_Full/CMU_Data/filenames_cmu/filenames/cmu_train.txt',
        'val'  : 'gdrive/MyDrive/CMU_Data_Full/CMU_Data/filenames_cmu/filenames/cmu_val.txt',
  ...
  def get_file_names(self, file_name_list):
    ...
    for line in f:
      ...
      # gt_img    = self.data_dir + 'disp/'  + line.split('.')[0] + '.tiff'
  ...
  def __getitem__(self, index):
    ...
    disp_img = self.clahe.apply(disp_img)
