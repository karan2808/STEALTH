...
parser.add_argument('--val_metric', default='d1', help='Validation metric to select best model')
...
def main():
    ...
    #optimizer = torch.optim.SGD(params_group, momentum = 0.9,  weight_decay=args.weight_decay)
