...
#                 --max_disp=192 \
#                 --thread=16 \
#                 --data_path='/home/rtml/aditi/data_scene_flow/' \
...
#                 --max_disp=192 \
#                 --thread=16 \
#                 --data_path='/home/rtml/aditi/data_scene_flow/training/' \
#                 --training_list='lists/kitti2015_train.list' \
#                 --save_path='./checkpoint/finetune_kitti2015' \
#                 --kitti2015=1 \
#                 --shift=3 \
#                 --resume='/home/rtml/aditi/sceneflow_epoch_10.pth' \
...
python train.py --batchSize=2 \
                ...
                --training_list='lists/CMU_Set_train_list.list' \
