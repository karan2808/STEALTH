...
parser.add_argument('--max_disp', type=int, default=96, help="max disp")
...
parser.add_argument('--data_path', type=str, default='/home/rtml/aditi/data_scene_flow/', help="data root")
