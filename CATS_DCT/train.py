...
# Initialize a model object/ load a saved model object:
myModel = MLPModel(256)
myModel.to(device)
...
train_valid(train_loader, valid_loader, num_epochs, myModel, optimizer, scheduler, model_save_path)
