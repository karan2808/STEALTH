...
class StereoDataset(Dataset):
    def __init__(self, data_dir,
        ...
        cats_all_dict = {
            'train': 'filenames/CATS_All_train.txt',
            'val': 'filenames/CATS_All_val.txt'
        }

        cats_new_dict = {
            'train': 'filenames/CATS_New_train.txt',
            'val': 'filenames/CATS_New_val.txt'
        }

        cats_clip_dict = {
            'train': 'filenames/CATS_Clip_train.txt',
            'val': 'filenames/CATS_Clip_val.txt'
        }
        cmu_dict = {
        ...
        cats_outdoor = {
            'train': 'filenames/CATS_outdoor_train.txt',
            'val': 'filenames/CATS_outdoor_val.txt'
        }

        cats_inferno = {
            'train': 'filenames/CATS_Inferno_train.txt',
            'val': 'filenames/CATS_Inferno_val.txt'
        }
        ...
        dataset_name_dict = {
            ...
            'CATS_indoor': cats_indoor_dict,
            'CATS_all': cats_all_dict,
            'CATS_new': cats_new_dict,
            'CATS_clip': cats_clip_dict,
            'CMU_SET' : cmu_dict,
            'CATS_OUT' : cats_outdoor,
            'CATS_INFERNO' : cats_inferno
        }
